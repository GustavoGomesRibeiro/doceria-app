...
import { Card, Container, Cart } from "@/components/index";
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 600,
            background:
              "radial-gradient(circle at 40% 40%, rgba(200,69,90,0.22) 0%, transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            ...
            height: 400,
            background:
              "radial-gradient(circle, rgba(184,135,58,0.15) 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center w-full">
            ...
            <div className="space-y-7 fade-up">
              ...
              <div
                className="pill"
                style={{
                  background: "rgba(200,69,90,0.18)",
                  color: "var(--rose-mid)",
                }}
              >
                <LuStar size={11} />
              ...
              <p
                ...
                style={{ color: "rgba(250,246,240,0.58)" }}
              >
            ...
            <div className="flex justify-center fade-up delay-2">
              <div className="relative">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(200,69,90,0.22) 0%, transparent 65%)",
                  }}
                />
                <div
          ...
          {[
            {
              ...
              sub: "Selecionados com cuidado",
            },
            {
              icon: "👩‍🍳",
              title: "Feito na hora",
              sub: "Após confirmação do pedido",
            },
            {
              icon: "🚚",
              title: "Entrega rápida",
              sub: "Combinamos o melhor horário",
            },
            {
              icon: "💬",
              title: "Pedido pelo WhatsApp",
              sub: "Simples e rápido",
            },
          ].map((b, i) => (
            <div
              key={i}
      ...
      <section style={{ background: "var(--bg)" }} id="cardapio">
        ...
        <div className="max-w-6xl mx-auto px-5 pt-14 pb-5">
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--ink-muted)" }}>
            ...
            {(tipoSelecionado === "bolo branco" ||
              ...
              "Encomenda com 2 dias de antecedência."}
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-5 pb-24">
          <Card
            produtos={
              tipoSelecionado
                ? produtos.filter((p) => p.tipo === tipoSelecionado)
                : produtos
            }
            isMobile={isMobile}
            id="produtos-grid"
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-5 py-24 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              <p>
                Tudo começou com receitas de família, passadas de geração em
                geração com aquele toque especial que só o amor é capaz de
                colocar.
              </p>
              <p>
                Na Reis Doces acreditamos que um bom doce transforma um momento
                simples numa memória afetiva para a vida inteira.
              </p>
            </div>
          ...
          >
            ...
            >
              &lsquo;Um doce caseiro carrega mais do que sabor — carrega
              memória, cuidado e o calor de mãos que preparam com amor.&rsquo;
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium" style={{ color: "#FAF6F0" }}>
                  Reis Doces Caseiros
                </p>
                <p
                  className="text-xs"
      ...
      >
        ...
        <div className="relative max-w-xl mx-auto px-5">
          ...
          <p
            ...
            style={{ color: "var(--ink-muted)" }}
          >
            Manda uma mensagem no WhatsApp — a gente te atende rapidinho e com
            todo o carinho!
          </p>
          <a
